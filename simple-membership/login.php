        ...
        <div class="membership-wrapper">
          <div class="email-password">
            ...
            <div class="swpm-login-submit">
                <input type="submit" class="swpm-login-form-submit" name="swpm-login" value="<?php echo SwpmUtils::_('dicks') ?>"/>
            </div>
            <?php } else { ?>
               <div class="swpm-login-submit">
               <input type="submit" class="swpm-login-form-submit" name="swpm-login" value="<?php echo SwpmUtils::_('Titties') ?>"/>
           </div>
           <?php } ?>
